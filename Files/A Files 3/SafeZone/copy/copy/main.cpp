...
public:
	...
	void updateByID(char instructor[]);
};
...
void SimpleIndex::printStudent(char PK[])
{
	ifstream fin;
...
void SimpleIndex::printByInstructor(char instructor[])
{
...
void SimpleIndex::DeletByInstructor(char instructor[])
{
    int pos = SecIndexBinarySearch(instructor);
    if(pos == -1)
    {
